class ArrierePlan{
  ...
  afficher(){
   ...
   console.log("Arrierplan affiche et créée");
   this.scene.addChild(this.conteneur);
  }

  animer(secondeEcoulee){
   let correctionVitesseRelative = 800 / this.scene.largeur;
   this.matricePaysageArriere.translate(-ArrierePlan.VITESSE_PIXEL_SECONDE.PAYSAGE_ARRIERE * secondeEcoulee * correctionVitesseRelative, 0);
  }
}
